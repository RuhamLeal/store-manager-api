...
describe('Testing Product Service', function () {
  ...
  it('Testing if the findAllProducts service returns all products correctly', async function () {
  ...
  it('Testing if the findAllProducts service returns undefined when occurring some error in database', async function () {
  ...
  it('Testing if the findProductByID service returns only the found product', async function () {
  ...
  it('Testing if the findProductByID service return error when passed a id that does not exist', async function () {
  ...
  it('Testing if the registerProduct service return error when passed a name with less than five characters', async function () {
  ...
  it('Testing if the registerProduct service return error when key "name" is not passed', async function () {
    sinon.stub(ProductModel, 'registerProduct').resolves();
  ...
  it('Testing if the updateProduct service update a product correctly', async function () {
  ...
  it('Testing if the updateProduct service return error when passed a name with less than five characters', async function () {
  ...
  it('Testing if the updateProduct service return error when key "name" is not passed', async function () {
    sinon.stub(ProductModel, 'updateProduct').resolves();
  ...
  it('Testing if the updateProduct service return error when passed a id that does not exist', async function () {
  ...
  it('Testing if the deleteProduct service return error when passed a id that does not exist', async function () {
